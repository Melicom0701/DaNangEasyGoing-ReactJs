...
import { Box, Button, Textarea, Text ,IconButton, Flex,Image} from '@chakra-ui/react';
...
const NewPost = ({Id, closePost}) => {
    ...
    const handlePostSubmit = async (e) => {
        // Add your logic here to submit the post
        //API 
        e.preventDefault();
    ...
    return (
        <div>
            ...
            >
                ...
                <Text fontSize="lg" fontWeight="bold">Viết Đánh Giá</Text>
                <Textarea
                    value={postText}
