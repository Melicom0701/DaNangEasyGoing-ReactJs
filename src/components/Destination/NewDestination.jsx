        ...
        <Box p={5}>
            ...
            <form onSubmit={handleSubmit}>
                <VStack spacing={4} align="stretch">
                    ...
                    <Button onClick={() => setOnMaps(true)}>Chọn vị trí trên bản đồ</Button>
                ...
                <label htmlFor="fileInput">
                    ...
                    <FormControl>
                        ...
                        <Input type="time" id="startTime" value={startTime} onChange={(e) => setStartTime(e.target.value)} step="1"/>
                    </FormControl>
                    
                    <FormControl>
                        <FormLabel htmlFor="endTime">End Time:</FormLabel>
                        <Input type="time" id="endTime" value={endTime} onChange={(e) => setEndTime(e.target.value)} step="1" />
                    </FormControl>
                    ...
                    <FormControl>
                        ...
                        <NumberInput min={0} precision={2}>
                            <NumberInputField id="averagePrice" value={averagePrice} onChange={(e) => setAveragePrice(e.target.value)} />
                        </NumberInput>
                    </FormControl>
                    ...
                    <Button colorScheme="blue" type="submit">Gửi Yêu Cầu</Button>
                </VStack>
            </form>
        {onMaps && (
        <div>
